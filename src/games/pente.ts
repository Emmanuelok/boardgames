    ...
    chapters: [
      {
        ...
        steps: [
          { title: 'The board', body: 'Play on the **intersections** of a 13×13 grid — 169 points. Black plays first, then players alternate, each placing one stone per turn. Stones never move once placed (though they can be captured and removed).' },
          { title: 'Win with five in a row', body: 'Make a row of **five of your stones** in a line: across, down, or on either diagonal. A line of six or more also wins — you simply need at least five adjacent stones with no gaps.', highlight: [82, 83, 84, 85, 86] },
          { title: 'The custodial capture', body: 'When you place a stone so the pattern is **YOU · OPP · OPP · YOU** along any of the eight directions — your new stone, then exactly two enemy stones in a row, then another of your stones — those **two flanked enemy stones are removed** and banked as one captured pair.', highlight: [83, 84, 85, 86] },
          { title: 'Only pairs — and only on YOUR move', body: 'Capture takes **exactly two** stones: a run of three (or one) bracketed this way is **never** captured. And it only fires for the stone you just placed — the bracketing player triggers it.', highlight: [83, 84, 85] },
          { title: 'You may move INTO a pair safely', body: 'Because capture only triggers on the bracketing player\'s placement, you can **safely drop a stone between two enemy stones**. Completing the YOU·OPP·OPP·YOU shape *yourself* never captures your own stone — only the flanker captures.', highlight: [83, 84, 85, 86] },
          { title: 'Win with five pairs', body: 'Capturing **five pairs** (ten enemy stones in all) wins the game outright, even with no line of five. Your captured-pair count is shown beside the board; the race to five pairs runs in parallel with the race to five in a row.' },
      ...
      },
      {
        ...
        steps: [
          { title: 'Beware the exposed pair', body: 'A **contiguous pair of your stones with both bracketing points empty** is a target: the opponent drops one stone on each end across two moves — or completes an existing bracket in one — and your pair is gone. Avoid laying two stones in a line with both ends open near enemy stones.', highlight: [84, 85] },
          { title: 'Captures break lines', body: 'A capture removes two stones, which can **shatter an enemy four or open three** instantly. Watching for a capture that also defuses a threat is often the strongest move on the board — defence and gain in one stroke.', highlight: [83, 84, 85, 86] },
          { title: 'The open three', body: 'As in Gomoku, three in a row with **both ends empty** is an open three — left alone it becomes an unstoppable open four. It is a forcing move your opponent must answer… unless they can answer it with a capture instead.', highlight: [83, 84, 85] },
          { title: 'The four', body: 'Four in a row with an open end threatens five immediately — your opponent must block it at once or lose. But beware: a four whose stones sit as a capturable pair can be **broken by capture** rather than blocked.', highlight: [82, 83, 84, 85] },
          { title: 'The double threat wins', body: 'Make **two threats in one move** — a four-three, a double four, or a line threat paired with a capture threat. The opponent defends only one; you carry out the other. Combining line threats with capture threats is the heart of Pente tactics.' },
          { title: "Black's edge", body: 'Moving first is a genuine advantage, sharper here than in Gomoku because the first capture can swing momentum hard. Open in the center, build toward a double threat, and keep your pairs guarded — that is the winning recipe.', highlight: [CENTER] },
        ],
      },
    ],
  },
