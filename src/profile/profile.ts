...
const GAME_CATEGORY: Record<string, string> = {
  ...
  clobber: 'Abstract',
  cohesion: 'Abstract',
  'five-field-kono': 'Abstract',
  konane: 'Abstract',
  'lines-of-action': 'Abstract',
  'order-and-chaos': 'Abstract',
  squava: 'Abstract',
  tally: 'Abstract',
  teeko: 'Abstract',
  ultimate: 'Abstract',
...
export const ACHIEVEMENTS: Achievement[] = [
  { id: 'first-win', title: 'First Victory', desc: 'Win your very first game.', icon: '🏅' },
  ...
  { id: 'beat-master', title: 'Master Challenger', desc: 'Beat a Master opponent.', icon: '♜' },
